...
def generator_model():
    ...
    # mult = 2**i
    en_1 = Conv2D(filters=64, kernel_size=(4, 4), strides=2, padding='same')(x)
    en_1 = BatchNormalization()(en_1)
    en_1 = Activation('relu')(en_1)

    en_2 = Conv2D(filters=128, kernel_size=(4, 4), strides=2, padding='same')(en_1)
    en_2 = BatchNormalization()(en_2)
    en_2 = Activation('relu')(en_2)

    en_3 = Conv2D(filters=256, kernel_size=(4, 4), strides=2, padding='same')(en_2)
    en_3 = BatchNormalization()(en_3)
    en_3 = Activation('relu')(en_3)

    en_4 = Conv2D(filters=512, kernel_size=(4, 4), strides=2, padding='same')(en_3)
    en_4 = BatchNormalization()(en_4)
    en_4 = Activation('relu')(en_4)

    en_5 = Conv2D(filters=1024, kernel_size=(4, 4), strides=2, padding='same')(en_4)
    ...
    up_1 = Conv2D(filters=512, kernel_size=(4, 4), padding='same')(up_1)
    merge_1 = concatenate([en_4, up_1], axis=3)
    de_1 = Conv2D(filters=512, kernel_size=(4, 4), padding='same')(merge_1)
    de_1 = BatchNormalization()(de_1)
    de_1 = Activation('relu')(de_1)

    up_2 = UpSampling2D()(de_1)
    up_2 = Conv2D(filters=256, kernel_size=(4, 4), padding='same')(up_2)
    merge_2 = concatenate([en_3, up_2], axis=3)
    de_2 = Conv2D(filters=256, kernel_size=(4, 4), padding='same')(merge_2)
    de_2 = BatchNormalization()(de_2)
    de_2 = Activation('relu')(de_2)

    up_3 = UpSampling2D()(de_2)
    up_3 = Conv2D(filters=128, kernel_size=(4, 4), padding='same')(up_3)
    merge_3 = concatenate([en_2, up_3], axis=3)
    de_3 = Conv2D(filters=128, kernel_size=(4, 4), padding='same')(merge_3)
    de_3 = BatchNormalization()(de_3)
    de_3 = Activation('relu')(de_3)

    up_4 = UpSampling2D()(de_3)
    up_4 = Conv2D(filters=64, kernel_size=(4, 4), padding='same')(up_4)
    merge_4 = concatenate([en_1, up_4], axis=3)
    de_4 = Conv2D(filters=64, kernel_size=(4, 4), padding='same')(merge_4)
    de_4 = BatchNormalization()(de_4)
    de_4 = Activation('relu')(de_4)

    up_5 = UpSampling2D()(de_4)
    up_5 = Conv2D(filters=64, kernel_size=(4, 4), padding='same')(up_5)
    merge_5 = concatenate([x, up_5], axis=3)
    de_5 = Conv2D(filters=64, kernel_size=(4, 4), padding='same')(merge_5)
    ...
    del en_1, en_2, en_3, en_4, en_5, de_1,de_2,de_3,de_4,de_5
